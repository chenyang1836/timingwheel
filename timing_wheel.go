...
func NewTimingWheel(tick time.Duration, wheelSize int64) *TimingWheel {
	...
	return newTimingWheel(
		...
		wheelSize,
		startMs,
		delay_queue.New(int(wheelSize)),
	)
}

// newTimingWheel is an internal helper function that really creates an instance of TimingWheel.
func newTimingWheel(tickMs int64, wheelSize int64, startMs int64, queue *delay_queue.DelayQueue) *TimingWheel {
